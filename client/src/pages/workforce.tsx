    ...
    try {
      ...
      const templateConfig: IdCardTemplateConfig = templateRes
        ? {
            ...
            backBackgroundImageUrl: (templateRes as Record<string, unknown>).backBackgroundImageUrl as string | null,
            ...
            backFieldPlacements: (lc.backFieldPlacements as IdCardTemplateConfig["backFieldPlacements"]) ?? undefined,
