        ...
        <div className="space-y-4 pt-1">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-white text-sm"><bdi>{event.region ? regionLabel(t, event.region) : "—"}</bdi></p>
            </div>
            <div>
                  ...
                  {filtered.map((evt) => {
                    ...
                    return (
                      <TableRow key={evt.id} className="border-border hover:bg-muted/20" data-testid={`row-event-${evt.id}`}>
                        ...
                        <TableCell className="hidden md:table-cell">
                          <span className="text-sm text-muted-foreground"><bdi>{evt.region ? regionLabel(t, evt.region) : "—"}</bdi></span>
                        </TableCell>
