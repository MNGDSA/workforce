...
const MESSAGES: Record<ServerLocale, MessageDict> = {
  en: {
    ...
    "geofence.polygonNotSupported":     "Polygon zones are not supported yet — please use circular zones (centre + radius). Polygon attendance verification is not implemented in this release.",
    "interview.notFound":               "Interview not found",
    "interview.archiveOnlyCompleted":   "Only completed interviews can be archived. Cancel the interview instead.",
    "interview.alreadyArchived":        "This interview is already archived.",
    ...
    "error.paymentMethodFlipBlocked"      : "Cannot change payment method while the employee still has unpaid pay-run lines. Wait until the pay run is completed, or pay out the open lines first.",
    ...
    "sms.reengagement"                    : "Workforce: We miss you! Sign in to your account to see new job opportunities: {{link}}",
    "sms.onboardingReminder"              : "Workforce: Your onboarding is incomplete. Please upload the following documents to keep your offer active: {{docs}}. Log in: {{link}}",
    "sms.onboardingFinalWarning"          : "Workforce: FINAL NOTICE — your onboarding will be cancelled in 24 hours unless you upload: {{docs}}. Log in now: {{link}}",
    "docs.photo"                          : "personal photo",
    "docs.iban"                           : "IBAN certificate",
    "docs.nationalId"                     : "national ID / Iqama",
    "docs.vaccinationReport"              : "vaccination report",
    ...
    "smp.candidateCannotApply"            : "You are currently assigned through your employer (SMP) and cannot apply to jobs directly.",
  ...
  ar: {
    ...
    "geofence.polygonNotSupported":     "النطاقات متعددة الأضلاع غير مدعومة حالياً — يرجى استخدام نطاقات دائرية (مركز + نصف قطر). التحقق من الحضور للأشكال متعددة الأضلاع غير مفعّل في هذا الإصدار.",
    "interview.notFound":               "المقابلة غير موجودة",
    "interview.archiveOnlyCompleted":   "لا يمكن أرشفة سوى المقابلات المكتملة. ألغِ المقابلة بدلاً من ذلك.",
    "interview.alreadyArchived":        "هذه المقابلة مؤرشفة بالفعل.",
    ...
    "error.paymentMethodFlipBlocked"      : "لا يمكن تغيير طريقة الدفع بينما لدى الموظف بنود دفع مفتوحة لم تُسوَّ بعد. انتظر حتى تكتمل دورة الدفع، أو سوِّ البنود المفتوحة أولاً.",
    ...
    "sms.reengagement"                    : "وورك فورس: نفتقدك! سجّل الدخول إلى حسابك لاستكشاف فرص العمل الجديدة: {{link}}",
    "sms.onboardingReminder"              : "وورك فورس: لم يكتمل تأهيلك بعد. يُرجى رفع المستندات التالية للحفاظ على عرض العمل: {{docs}}. تسجيل الدخول: {{link}}",
    "sms.onboardingFinalWarning"          : "وورك فورس: تنبيه أخير — سيتم إلغاء تأهيلك خلال 24 ساعة ما لم ترفع: {{docs}}. سجّل الدخول الآن: {{link}}",
    "docs.photo"                          : "الصورة الشخصية",
    "docs.iban"                           : "شهادة الآيبان",
    "docs.nationalId"                     : "الهوية الوطنية / الإقامة",
    "docs.vaccinationReport"              : "تقرير التطعيم",
    ...
    "smp.candidateCannotApply"            : "أنت معيّن حالياً عبر شركتك (SMP) ولا يمكنك التقدم إلى الوظائف مباشرة.",
