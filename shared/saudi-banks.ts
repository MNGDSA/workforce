...
//
// Lives in `shared/` so both the client (form auto-fill) and the server
// (write-time persistence in candidate create/update routes — task #121)
// resolve IBAN -> bank from a single source of truth.
